...
class SceneHome extends Scene{
    ...
    Draw(){
        ...
        this._Buttons.Add('TagName',new Button(this.userName,"center",0,this.CANVAS_HEIGHT/6-130,140,45,'white','black',()=>{
            gameUIManager.ShowDialog(LoginForm)}));
        ...
        this._Buttons.Draw();
            ...
            this.context.drawImage(this.tagname, 0, this.CANVAS_HEIGHT / 3-215 - this.tagname.height / 6, this.tagname.width/3, this.tagname.height/6);   
